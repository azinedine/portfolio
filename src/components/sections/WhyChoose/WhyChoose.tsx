...
const reasons = [
  {
    ...
    description:
      "Every project is crafted with precision and attention to detail, ensuring optimal performance and user experience.",
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    description:
      "Your success is my priority. I work closely with clients to understand their vision and bring it to life.",
  },
  {
    icon: Award,
          ...
          >
            <motion.div variants={itemVariants} className="mb-8">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-lg">
                Discover what makes working with me different and why clients
                choose my development services.
              </p>
            </motion.div>
            ...
            >
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="text-center p-4 rounded-xl hover:bg-white/5 transition-all duration-200 cursor-pointer"
                >
          ...
          >
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <p className="text-white font-medium text-sm">Mike Wilson</p>
